...
$pages = $this->cms_tpv_get_pages( $get_pages_args );
...
// Count code for WPML, mostly taken/inspired from  WPML Multilingual CMS, sitepress.class.php
    ...
    $wpml_post_counts = $this->cms_tpv_get_wpml_post_counts( $post_type );
...
ob_start();
$this->cms_tpv_print_childs( 0, $cms_tpv_view, $jstree_open, $post_type );
...
<div class="cms_tpv_wrapper">
    ...
    <input type="hidden" name="cms_tpv_meta_post_type_hierarchical"
           value="<?php echo (int) $this->cms_tpv_is_post_type_hierarchical( $post_type_object ) ?>"/>
...
?>
    <ul class="cms-tpv-subsubsub cms-tpv-subsubsub-select-view">
        <li class="cms_tvp_view_is_status_view">
            <a class="cms_tvp_view_all  <?php echo ( $cms_tpv_view == "all" ) ? "current" : "" ?>"
        ...
        <li class="cms_tvp_view_is_status_view">
            <a class="cms_tvp_view_public <?php echo ( $cms_tpv_view == "public" ) ? "current" : "" ?>"
        ...
        <li class="cms_tvp_view_is_status_view">
            <a class="cms_tvp_view_trash <?php echo ( $cms_tpv_view == "trash" ) ? "current" : "" ?>"
    ...
    ?>
        ...
        <li>
            <form class="cms_tree_view_search_form" method="get" action="">
                ...
                <a title="<?php _e( "Clear search", 'swiftypages' ) ?>" class="cms_tree_view_search_form_reset"
                   href="#">x</a>
                <input type="submit" class="cms_tree_view_search_submit button button-small"
                       value="<?php _e( "Search", 'swiftypages' ) ?>"/>
                <span class="cms_tree_view_search_form_working"><?php _e( "Searching...", 'swiftypages' ) ?></span>
                <span class="cms_tree_view_search_form_no_hits"><?php _e( "Nothing found.", 'swiftypages' ) ?></span>
            </form>
        </li>
    ...
    <div class="updated below-h2 hidden cms_tpv_search_no_hits">
        <p><?php _e( "Search: no pages found", 'swiftypages' ) ?></p></div>
...
<span class="ss-page-actions-tmpl __TMPL__ ss-hidden">
    ...
    <span class="button button-primary ss-button ss-button-page-settings" data-ss-action="settings" title='<?php _e( "Edit page", 'swiftypages' ) ?>'>
        <span class="dashicons ss-icon dashicons-admin-generic"></span>
    </span>
    <span class="button button-primary ss-button ss-button-delete-page" data-ss-action="delete" title='<?php _e( "Delete page", 'swiftypages' ) ?>'>
        <span class="dashicons ss-icon dashicons-no"></span>
    </span>
    <span class="button button-primary ss-button ss-button-edit-page" data-ss-action="edit" title='<?php _e( "Edit page content", 'swiftypages' ) ?>'>
        <span class="dashicons ss-icon dashicons-admin-tools"></span>
    </span>
    <span class="button button-primary ss-button ss-button-view-page" data-ss-action="view" title='<?php _e( "View page", 'swiftypages' ) ?>'>
