...
jQuery( function ( $ ) {
        ...
        "json_data": {
            "ajax": {
                ...
                "success": function ( data, status ) {
                    ...
                    if ( data === null || !data ) {
                        cms_tpv_message.html( "<p>" + swiftypages_l10n["No posts found"] + "</p>" );
    ...
    cms_tpv_tree.each( function ( i, elm ) {
        ...
        treeOptionsTmp.search.ajax.url = ajaxurl + '?action=swiftypages_get_childs&view=' + $.data( document, 'swiftypages_view' ) + "&post_type=" + cms_tpv_get_post_type( this );
...
function cms_tvp_set_view( view, elm ) {
    ...
    treeOptionsTmp.json_data.ajax.url = ajaxurl + '?action=swiftypages_get_childs&view=' + view + "&post_type=" + cms_tpv_get_post_type( elm ) + "&lang=" + cms_tpv_get_wpml_selected_lang( elm );
